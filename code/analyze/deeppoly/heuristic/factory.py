    ...
    def create(self):
        ...
        if isinstance(self.net, Conv):
            return H.Sequential([
                    ...
                    O.Optimize(inspector.get_relu_input_sizes(), LF.loss_sum, timeout=170, debug=False),
            ], timeout=170)


        return O.Optimize(inspector.get_relu_input_sizes(), LF.loss_sum, timeout=170, debug=False)
